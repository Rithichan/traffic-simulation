...
def simulate(car_num,road_len,itr,light_duration):

    v_max = 5
    t = 0
    t_max = itr
    past_cars = 0
    traffic_light = 0 #if even green for road 1

    cars_1 , cars_2 = initialize(car_num,road_len)

    while t < t_max:

        if t%light_duration == 0:
            traffic_light += 1
        ...
        for car_index_1 in range(len(cars_1)):
            ...
            if vehicle_pos < road_len/2:
                if vehicle_pos + vehicle_v >= road_len/2:
                    ...
                    if traffic_light%2 == 0: #even is green, odd is red
        ...
        for car_index_2 in range(len(cars_2)):
            ...
            if vehicle_pos < road_len/2:
                if vehicle_pos + vehicle_v >= road_len/2:
                    ...
                    if traffic_light%2 == 1: #odd is green, even is red
